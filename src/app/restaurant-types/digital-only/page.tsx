      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto overflow-hidden bg-zinc-50/50 rounded-[3rem]">
        <div className="text-center max-w-4xl mx-auto mb-16">
          ...
          <motion.p initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }} className="text-base text-zinc-600 max-w-2xl mx-auto">
            Digital-only restaurants operate without a physical dine-in space, relying entirely on online orders and delivery platforms. Dine360 brings everything together � helping you control orders, optimize operations, and scale your digital restaurant with ease.
          </motion.p>
        </div>
